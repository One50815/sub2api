...
describe('PaymentView retired subscription entry', () => {
  it('routes legacy subscription links to Omnio Pro without exposing legacy plans', async () => {
    ...
    expect(wrapper.text()).toContain('Omnio Pro')
