...
<template>
  <div class="card p-5 sm:p-6">
    ...
    <div v-else class="overflow-hidden rounded-[var(--omnio-radius-panel)] border border-[var(--omnio-border)]">
    ...
    >
      ...
      <div v-else class="space-y-5">
        <div class="rounded-[var(--omnio-radius-control)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-control)] p-4">
          <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
              <div class="flex items-center gap-2 rounded-[var(--omnio-radius-control)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-raised)] px-2 py-1 shadow-[var(--omnio-control-shadow)]">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div class="rounded-[var(--omnio-radius-control)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-control)] p-4">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-2">
                ...
                <a
                  class="inline-flex items-center gap-1 rounded-full border border-[var(--omnio-border)] bg-[var(--omnio-surface-raised)] px-2 py-1 text-[11px] font-bold text-gray-700 shadow-[var(--omnio-control-shadow)] hover:border-[var(--omnio-border-strong)] dark:text-gray-200"
        ...
        <div class="rounded-[var(--omnio-radius-panel)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-raised)] p-4">
          ...
          <div v-else class="overflow-hidden rounded-[var(--omnio-radius-control)] border border-[var(--omnio-border)]">
