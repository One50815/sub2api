  ...
  <div class="card flex h-full flex-col p-5 sm:p-6">
    <div class="mb-4 flex shrink-0 items-center justify-between">
      ...
      <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
        ...
        <template v-if="!props.fullscreen">
          <button
            type="button"
            class="ml-2 btn btn-secondary btn-sm !min-h-0 !px-2 !py-1 !text-[11px]"
    ...
    <div v-if="(props.topGroups?.length ?? 0) > 0" class="mb-3 flex flex-wrap gap-2">
      <button
        ...
        :key="g.group_id"
        type="button"
        class="inline-flex items-center gap-2 rounded-full border border-[var(--omnio-border)] bg-[var(--omnio-surface-control)] px-3 py-1 text-[11px] font-semibold text-gray-700 shadow-[var(--omnio-control-shadow)] hover:border-[var(--omnio-border-strong)] dark:text-gray-200"
