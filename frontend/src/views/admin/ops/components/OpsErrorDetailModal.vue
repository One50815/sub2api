  ...
  <BaseDialog :show="show" :title="title" width="full" :close-on-click-outside="true" @close="close">
    ...
    <div v-else class="space-y-6 p-6">
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div class="rounded-[var(--omnio-radius-control)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-control)] p-4">
        ...
        <div v-if="detail.api_key_prefix" class="rounded-[var(--omnio-radius-control)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-control)] p-4">
      ...
      <div class="rounded-[var(--omnio-radius-panel)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-control)] p-5 sm:p-6">
        ...
        <pre class="mt-4 max-h-[520px] overflow-auto rounded-[var(--omnio-radius-control)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-raised)] p-4 text-xs text-gray-800 dark:text-gray-100"><code>{{ prettyJSON(primaryResponseBody || '') }}</code></pre>
      </div>

      <!-- Upstream errors list (only for request errors) -->
      <div v-if="showUpstreamList" class="rounded-[var(--omnio-radius-panel)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-control)] p-5 sm:p-6">
        ...
        <div v-else class="mt-4 space-y-3">
          ...
          >
            ...
            <pre
              ...
              class="mt-3 max-h-[240px] overflow-auto rounded-[var(--omnio-radius-control)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-control)] p-3 text-xs text-gray-800 dark:text-gray-100"
