...
<template>
  <div class="space-y-6">
    ...
    <div :class="['card', props.fullscreen ? 'p-8' : 'p-5 sm:p-6']">
      ...
      <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-12">
        <div class="rounded-[var(--omnio-radius-panel)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-control)] p-4 lg:col-span-5">
        ...
        <div class="lg:col-span-7">
          <div class="grid h-full grid-cols-1 content-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div v-for="i in 6" :key="i" class="h-20 animate-pulse rounded-[var(--omnio-radius-panel)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-control)]"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4">
      <div :class="['card min-h-[360px] lg:col-span-1', props.fullscreen ? 'p-8' : 'p-5 sm:p-6']">
        <div class="h-4 w-44 animate-pulse rounded bg-gray-200 dark:bg-dark-700"></div>
        <div class="mt-6 h-72 animate-pulse rounded-[var(--omnio-radius-panel)] bg-[var(--omnio-surface-control)]"></div>
      </div>
      <div :class="['card min-h-[360px] lg:col-span-1', props.fullscreen ? 'p-8' : 'p-5 sm:p-6']">
        <div class="h-4 w-44 animate-pulse rounded bg-gray-200 dark:bg-dark-700"></div>
        <div class="mt-6 h-72 animate-pulse rounded-[var(--omnio-radius-panel)] bg-[var(--omnio-surface-control)]"></div>
      </div>
      <div :class="['card min-h-[360px] lg:col-span-2', props.fullscreen ? 'p-8' : 'p-5 sm:p-6']">
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
      <div
        v-for="i in 3"
        :key="i"
        :class="['card', props.fullscreen ? 'p-8' : 'p-5 sm:p-6']"
      >
        <div class="h-4 w-44 animate-pulse rounded bg-gray-200 dark:bg-dark-700"></div>
        <div class="mt-6 h-56 animate-pulse rounded-[var(--omnio-radius-panel)] bg-[var(--omnio-surface-control)]"></div>
      </div>
    </div>
    ...
    <div :class="['card', props.fullscreen ? 'p-8' : 'p-5 sm:p-6']">
      ...
      <div class="mt-6 space-y-3">
        <div v-for="i in 6" :key="i" class="flex items-center justify-between gap-4 rounded-[var(--omnio-radius-panel)] border border-[var(--omnio-border)] bg-[var(--omnio-surface-control)] p-4">
