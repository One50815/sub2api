export default {
    ...
    groups: {
      ...
      form: {
        ...
        platform: '平台',
        rateMultiplier: '普通用户倍率',
        omnioProSettings: 'Omnio Pro 独立配置',
        omnioProRateMultiplier: 'Omnio Pro 倍率',
        omnioProRatePlaceholder: '留空则使用普通用户倍率',
        omnioProRateHint: '仅对有效 Omnio Pro 用户生效，不会修改普通用户倍率',
        omnioProOnly: '仅 Omnio Pro 可见和绑定',
        omnioProOnlyHint: '开启后，普通用户看不到该分组，也无法通过 API 绑定',
        omnioProDailyFree: 'Pro 每日免费额度（USD）',
        omnioProDailyFreeHint: '按北京时间每日重置；留空或 0 表示不提供每日免费额度',
        omnioProMonthlyFree: 'Pro 每月免费额度（USD）',
        omnioProMonthlyFreeHint: '按北京时间自然月重置；留空或 0 表示不提供月度免费额度',
        omnioProQuotaWalletHint: '请求优先消耗免费额度，超出每日或月度上限的部分自动扣除钱包余额。',
        status: '状态',
        exclusive: '专属分组',
        nameLabel: '分组名称',
      ...
      exclusiveTooltip: {
        ...
        example: '使用场景：',
        exampleContent:
          '公开分组费率 0.8，您可以为 Omnio Pro 配置独立的 0.7 倍率，让 Pro 用户享受优惠且不修改公开分组倍率。'
      },
      rateMultiplierHint: '1.0 = 标准费率，0.5 = 半价，2.0 = 双倍',
      platforms: {
        all: '全部平台',
      ...
      failedToLoadOmnioProSettings: '加载该分组的 Omnio Pro 设置失败',
      failedToSave: '保存分组失败',
