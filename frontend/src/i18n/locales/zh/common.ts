export default {
  ...
  // Auth
  auth: {
    gatewayEyebrow: 'AI API 网关',
    gatewayTitle: '一个网关。',
    gatewayTitleAccent: '连接每个模型。',
    gatewayDescription: '通过一个安全、统一的 API 接入 100+ AI 模型。',
    gatewayUnified: '统一接入',
    gatewayUnifiedDetail: '所有模型，一个 API',
    gatewayRouting: '智能路由',
    gatewayRoutingDetail: '兼顾速度与成本',
    gatewayReliable: '可靠安全',
    gatewayReliableDetail: '稳定的服务保障',
    welcomeBack: '欢迎回来',
    signInToAccount: '登录你的 {siteName} 账户',
    signIn: '登录',
    signingIn: '登录中...',
