export default {
  ...
  // Auth
  auth: {
    gatewayEyebrow: '隐私优先的模型网关',
    gatewayTitle: '请求清楚。',
    gatewayTitleAccent: '选择透明。',
    gatewayDescription: '请求明文阅后即焚。选择什么模型就使用什么模型，费用也清楚呈现。',
    gatewayUnified: '明文阅后即焚',
    gatewayUnifiedDetail: '不留存请求正文',
    gatewayRouting: '模型选择透明',
    gatewayRoutingDetail: '不做隐藏替换',
    gatewayReliable: '费用清楚可查',
    gatewayReliableDetail: '用量与价格可追溯',
    welcomeBack: '欢迎回来',
    signInToAccount: '登录 {siteName}，继续使用你的模型工作区',
    signIn: '登录',
    signingIn: '登录中...',
    ...
    signUpToStart: '加入 {siteName}，从真实模型与透明价格开始',
    signUp: '注册',
    processing: '处理中...',
    continue: '继续',
    rememberMe: '记住我',
    ...
    wechatPayment: {
      ...
      callbackHint: '验证支付结果后页面会自动跳转，请稍候。',
      backToPayment: '返回支付页',
    ...
    oauth: {
      ...
      processingTitle: '正在安全登录',
      processingDescription: '正在连接您的账户，请稍候。',
      processing: '正在处理 OAuth 响应...',
      processingNote: '验证请求并更新会话可能需要一点时间。',
