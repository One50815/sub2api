export default {
  ...
  // Auth
  auth: {
    gatewayEyebrow: 'AI API GATEWAY',
    gatewayTitle: 'One Gateway.',
    gatewayTitleAccent: 'Every Model.',
    gatewayDescription: 'Connect to 100+ AI models through one secure, unified API.',
    gatewayUnified: 'Unified access',
    gatewayUnifiedDetail: 'All models, one API',
    gatewayRouting: 'Smart routing',
    gatewayRoutingDetail: 'Optimal speed and cost',
    gatewayReliable: 'Reliable and secure',
    gatewayReliableDetail: 'Stable service delivery',
    welcomeBack: 'Welcome Back',
    signInToAccount: 'Sign in to your {siteName} account',
    signIn: 'Sign In',
