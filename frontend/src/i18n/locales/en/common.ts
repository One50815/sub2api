export default {
  common: {
    ...
    omnioPro: 'Omnio Pro',
    membership: 'Omnio Pro',
    proExclusive: 'Pro only',
    manualRate: 'Manual',
    save: 'Save',
  ...
  nav: {
    ...
    apiKeys: 'API Keys',
    imageGeneration: 'Image Playground',
    ...
    subscriptions: 'Omnio Pro Management',
    accounts: 'Accounts',
    proxies: 'Proxies',
    ...
    logout: 'Logout',
    github: 'GitHub',
    mySubscriptions: 'Omnio Pro',
    buySubscription: 'Recharge / Omnio Pro',
    membership: 'Omnio Pro',
    docs: 'Docs',
    myOrders: 'My Orders',
  ...
  // Auth
  auth: {
    gatewayEyebrow: 'Privacy-first model access',
    gatewayTitle: 'Clear requests.',
    gatewayTitleAccent: 'Honest choices.',
    gatewayDescription: 'Plaintext is discarded after each request. The model you choose is the model you get, with clear pricing.',
    gatewayUnified: 'Plaintext discarded',
    gatewayUnifiedDetail: 'Request content is not retained',
    gatewayRouting: 'Transparent model choice',
    gatewayRoutingDetail: 'No hidden substitutions',
    gatewayReliable: 'Pricing you can verify',
    gatewayReliableDetail: 'Traceable usage and cost',
    welcomeBack: 'Welcome back',
    signInToAccount: 'Sign in to {siteName} and continue to your model workspace',
    signIn: 'Sign In',
    ...
    signUpToStart: 'Join {siteName} for real models and transparent pricing',
    signUp: 'Sign up',
    processing: 'Processing...',
    continue: 'Continue',
    ...
    linuxdo: {
      ...
      invitationRequired: 'This Linux.do account is not yet registered. The site requires an invitation code. Enter one to complete registration.',
    ...
    dingtalk: {
      ...
      callbackMissingToken: 'Missing login token, please try again.',
      backToLogin: 'Back to Login',
      invitationRequired: 'This DingTalk account is not yet registered. The site requires an invitation code. Enter one to complete registration.',
    ...
    oidc: {
      ...
      backToLogin: 'Back to Login',
      invitationRequired:
        'This {providerName} account is not yet registered. The site requires an invitation code. Enter one to complete registration.',
    ...
    wechatPayment: {
      ...
      callbackHint: 'You will be redirected automatically after we validate the payment response.',
    ...
    oauth: {
      ...
      processingTitle: 'Signing you in securely',
      processingDescription: 'Hang tight while we finish connecting your account.',
      processing: 'Processing OAuth response...',
      processingNote: 'This may take a few moments while we validate the request and update your session.',
