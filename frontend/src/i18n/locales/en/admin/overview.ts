export default {
    ...
    groups: {
      ...
      columns: {
        ...
        id: 'ID',
        platform: 'Platform',
        rateMultiplier: 'Standard User Multiplier',
      ...
      form: {
        ...
        platform: 'Platform',
        rateMultiplier: 'Standard User Multiplier',
        omnioProSettings: 'Omnio Pro Settings',
        omnioProRateMultiplier: 'Omnio Pro Multiplier',
        omnioProRatePlaceholder: 'Blank uses the standard multiplier',
        omnioProRateHint: 'Applies only to active Omnio Pro users without changing the standard multiplier',
        omnioProOnly: 'Visible and bindable only to Omnio Pro',
        omnioProOnlyHint: 'Standard users cannot see or bind this group when enabled',
        omnioProDailyFree: 'Pro Daily Free Credit (USD)',
        omnioProDailyFreeHint: 'Resets daily in Asia/Shanghai; blank or 0 disables the daily credit',
        omnioProMonthlyFree: 'Pro Monthly Free Credit (USD)',
        omnioProMonthlyFreeHint: 'Resets each calendar month in Asia/Shanghai; blank or 0 disables the monthly credit',
        omnioProQuotaWalletHint: 'Requests use free credit first; any amount above the daily or monthly cap is charged to the wallet.',
        status: 'Status',
      ...
      exclusiveTooltip: {
        ...
        example: 'Use case:',
        exampleContent: 'Keep the public group rate at 0.8 and configure a separate 0.7 Omnio Pro rate without changing the public multiplier.'
      },
      ...
      failedToLoadOmnioProSettings: 'Failed to load Omnio Pro settings for this group',
