  ...
  <div>
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        <div
          v-if="isModalOpen"
          class="announcement-overlay fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto bg-black/50 p-4 pt-[8vh] backdrop-blur-sm"
          @click="closeModal"
        >
          <div
            class="announcement-panel w-full max-w-[620px] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl dark:border-dark-700 dark:bg-dark-800"
            @click.stop
          >
            <!-- Header with Gradient -->
            <div class="announcement-header relative overflow-hidden border-b border-gray-100 px-6 py-5 dark:border-dark-700">
            ...
            <div class="max-h-[65vh] overflow-y-auto">
              ...
              <div v-else-if="announcements.length > 0">
                ...
                >
                  ...
                  <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center">
                    <div
                      v-if="!item.read_at"
                      class="relative flex h-9 w-9 items-center justify-center rounded-md bg-blue-600 text-white"
                    >
                      <!-- Pulse ring -->
                  ...
                  <div
                    v-if="!item.read_at"
                    class="absolute left-0 top-0 h-full w-0.5 bg-blue-500"
                  ></div>
                </div>
              </div>
              ...
              <div v-else class="flex flex-col items-center justify-center py-16">
                <div class="relative mb-4">
                  <div class="flex h-12 w-12 items-center justify-center rounded-lg border border-gray-200 bg-gray-50 dark:border-dark-700 dark:bg-dark-700">
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        <div
          ...
          class="announcement-overlay fixed inset-0 z-[110] flex items-start justify-center overflow-y-auto bg-black/50 p-4 pt-[6vh] backdrop-blur-sm"
          @click="closeDetail"
        >
          <div
            class="announcement-panel w-full max-w-[780px] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl dark:border-dark-700 dark:bg-dark-800"
            @click.stop
          >
            <!-- Header with Decorative Elements -->
            <div class="announcement-header relative overflow-hidden border-b border-gray-100 px-8 py-6 dark:border-dark-700">
                  ...
                  <div class="mb-3 flex items-center gap-2">
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <span
                        ...
                        class="inline-flex items-center gap-1.5 rounded-full bg-blue-100 px-2.5 py-1 text-xs font-medium text-blue-700 dark:bg-blue-500/15 dark:text-blue-300"
                      >
            ...
            <div class="max-h-[60vh] overflow-y-auto bg-white px-8 py-8 dark:bg-dark-800">
              ...
              <div class="relative">
                ...
                <div class="absolute left-0 top-0 bottom-0 w-0.5 rounded-full bg-blue-500"></div>
...
.markdown-body th {
  @apply bg-gray-50 font-semibold text-gray-900 dark:bg-dark-900/70 dark:text-white;
}
