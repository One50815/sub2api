<template>
  ...
  <Teleport to="body">
    <Transition name="agreement-fade">
      <div
        v-if="dialogVisible"
        class="modal-overlay !z-[140] overflow-y-auto"
      >
        <div class="modal-content max-w-[600px] overflow-hidden">
          ...
          <div class="max-h-[58vh] overflow-y-auto px-6 py-5">
            ...
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <RouterLink
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="group flex min-h-[72px] w-full items-center gap-3 rounded-[1.25rem] border border-gray-200 bg-gray-50/70 px-4 py-3 text-left transition hover:-translate-y-0.5 hover:border-primary-200 hover:bg-white hover:shadow-sm dark:border-dark-700 dark:bg-dark-800/70 dark:hover:border-primary-500/30 dark:hover:bg-dark-800"
              >
